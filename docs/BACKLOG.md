...
**Trigger to reconsider**: User asks for "next mobile UX section" — next up is **D (nav)** since A, B, and C have shipped. D touches every page and best done after the screens themselves are stable. **E remainder** and **F** are quickest — sprinkle in alongside D.

Suggested order (~~A~~ ~~B~~ ~~C~~ shipped 2026-05-03 / 2026-05-25): **D → E remainder → F**.
