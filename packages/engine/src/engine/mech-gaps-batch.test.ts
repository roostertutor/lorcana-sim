...
import { getInstance, getZone, getEffectiveStrength, hasKeyword } from "../utils/index.js";
...
// =============================================================================
// Batch-4 mechanics (originally batch-4mech.test.ts; folded in 2026-04-24):
...
describe("Mechanic gaps batch — alert-keyword (CRD 10.x)", () => {
...
describe("Mechanic gaps batch — timed-cant-be-challenged (Safe and Sound)", () => {
...
describe("Mechanic gaps batch — exert-filtered-cost (Scrump)", () => {
...
describe("Mechanic gaps batch — both-players-effect (Show Me More!)", () => {
