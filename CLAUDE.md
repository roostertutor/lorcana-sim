...
- server:    done (core). Hono + Supabase. Anti-cheat state filtering, ELO (K=32), action logging for clone trainer. Remaining: Railway deploy, token refresh, OAuth. See `docs/MULTIPLAYER.md`.
