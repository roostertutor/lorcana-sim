...
// and generates the same per-set JSONs as the Lorcast importer, preserving
...
// (direct foil-mask URL pairing), includes Iconic/Epic cards Lorcast doesn't
...
// Matches the existing Lorcast-importer slugify exactly — NOT a "better" one.
...
// =============================================================================
// MERGE LOGIC (duplicated from scripts/import-cards.ts — keeps hand-wired
